...
class SolverRuleTests(unittest.TestCase):
    ...
    def test_get_free_space_success_is_not_opal_method(self):
        trajectory = owned_admin_context() + [
            start_session(ADMIN_SP),
    ...
    def test_get_free_rows_success_is_not_opal_method(self):
        trajectory = owned_admin_context() + [
            start_session(ADMIN_SP),
    ...
    def test_k_aes_set_success_is_invalid_because_key_changes_use_genkey(self):
        trajectory = activated_locking_context() + [
            start_session(LOCKING_SP, ADMIN1, "new"),
    ...
    def test_port_get_requires_sid_or_admin(self):
        trajectory = owned_admin_context() + [
            start_session(ADMIN_SP),
